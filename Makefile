...
generate:
	...
	@mockgen -source=tfstate/tfstate_iface/s3_downloader.go -destination test/mock_tfstate_iface/mock_s3_downloader.go
	@mockgen -source=tfstate/tfstate_iface/state_loader.go -destination test/mock_tfstate_iface/mock_state_loader.go
